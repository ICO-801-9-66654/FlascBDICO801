...
from models import Maestros, db, Alumnos
import forms
...
@app.route("/maestros")
def maestro():
    create_maestro = forms.MaestrosForm(request.form)
    maestro = Maestros.query.all()
    return render_template("maestros/maestros.html", form=create_maestro, maestro=maestro)
